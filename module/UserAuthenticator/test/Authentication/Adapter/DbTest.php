...
use UserAuthenticator\Mapper\UserInterface as UserInterfaceMapper;
...
class DbTest extends TestCase
{
     ...
     * Mock of AuthEvent.
     *
     * @var \UserAuthenticator\Authentication\Adapter\AdapterChainEvent|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $authEvent;
     ...
     * Mock of Options.
     *
     * @var \UserAuthenticator\Options\ModuleOptions|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $options;
     ...
     * Mock of Mapper.
     *
     * @var \UserAuthenticator\Mapper\UserInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $mapper;
     ...
     * Mock of User.
     *
     * @var \UserAuthenticator\Model\UserInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $user;
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::logout
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::Authenticate
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::updateUserPasswordHash
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::preprocessCredential
     * @covers \UserAuthenticator\Authentication\Adapter\Db::setCredentialPreprocessor
     * @covers \UserAuthenticator\Authentication\Adapter\Db::getCredentialPreprocessor
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::setServiceManager
     * @covers \UserAuthenticator\Authentication\Adapter\Db::getServiceManager
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::getOptions
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::setOptions
     * @covers \UserAuthenticator\Authentication\Adapter\Db::getOptions
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::getMapper
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\Db::setMapper
     * @covers \UserAuthenticator\Authentication\Adapter\Db::getMapper
     */
