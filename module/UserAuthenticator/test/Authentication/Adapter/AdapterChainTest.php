...
use UserAuthenticator\Authentication\Adapter\ChainableAdapter;
use UserAuthenticator\Authentication\Storage\Db;
use UserAuthenticator\Exception\AuthenticationEventException;
...
class AdapterChainTest extends TestCase
{
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::authenticate
     */
    ...
    /**
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::resetAdapters
     */
     ...
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::prepareForAuthentication
     */
     ...
     *
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::getEvent
     */
     ...
     *
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::setEvent
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::getEvent
     */
     ...
     * @covers \UserAuthenticator\Authentication\Adapter\AdapterChain::logoutAdapters
     */
