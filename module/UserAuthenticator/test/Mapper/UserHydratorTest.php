...
use UserAuthenticator\Mapper\UserHydrator as Hydrator;
use stdClass;
use UserAuthenticator\Mapper\Exception\InvalidArgumentException;
...
class UserHydratorTest extends TestCase
{
    ...
    /**
     * @covers UserAuthenticator\Mapper\UserHydrator::extract
     */
    ...
    /**
     * @covers UserAuthenticator\Mapper\UserHydrator::extract
     * @covers UserAuthenticator\Mapper\UserHydrator::mapField
    ...
    /**
     * @covers UserAuthenticator\Mapper\UserHydrator::hydrate
     */
