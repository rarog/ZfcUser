...
use UserAuthenticator\Validator\AbstractRecord;
use UserAuthenticator\Validator\NoRecordExists as Validator;
...
class NoRecordExistsTest extends TestCase
{
    ...
    /**
     * @covers UserAuthenticator\Validator\NoRecordExists::isValid
     */
